...
export const SKINS: Record<string, Skin> = {
  ...
  sunrise: { id: "sunrise", name: "Sunrise", tier: "uncommon", kind: "gradient", colors: ["#2196F3", "#64B5F6", "#FFEB3B", "#FF9800", "#F44336"] }, // Sunrise vertical gradient
  ...
  confetti: { id: "confetti", name: "Confetti", tier: "rare", kind: "gradient", colors: ["#FEF3C7", "#FDE68A"] }, // Light yellow horizontal gradient
  ...
  sprinkles: { 
    ...
    pattern: { type: "confetti_dots", count: 18, colors: ["#FF6B6B", "#4ECDC4", "#45B7D1", "#FFA07A"], alpha: 0.50 }
  },
  berry_fizz: { 
    id: "berry_fizz", 
    name: "Berry Fizz", 
