...
export const SKINS: Record<string, ShopSkin> = {
  // ===== COMMONS =====
  moss: {
    id: "moss",
    name: "Moss",
  ...
  aurora: {
    ...
    base: {
      fill: "#1f7e84", // Darker teal for contrast
      stroke: "#1e293b",
      shine: "#ffffff"
    },
    gradient: {
  ...
  sprinkles: {
    ...
    base: {
      fill: "#f9a8d4", // Lighter pink for more contrast
      stroke: "#be185d", // Darker pink outline
      shine: "#0E1B2B"
    },
    pattern: {
      type: "confetti_dots",
  ...
  vanilla_sprinkles: {
    ...
    base: {
      ...
      stroke: "#8b5e34", // Darker vanilla/brown outline
      shine: "#ffffff"
    },
    pattern: {
      type: "confetti_dots",
