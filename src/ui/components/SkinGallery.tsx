...
import { X, Palette, Sparkles, MapPin } from "lucide-react";
...
function GallerySlime({ skin, size = "normal", instanceId }: { skin: UnifiedSkin; size?: "small" | "normal" | "large"; instanceId?: string }) {
  ...
  if (skin.source === "production") {
    // V1 Launch Roster - map to actual skin IDs in SKINS registry
    const mapping: Record<string, string> = {
      ...
      "coral": "coral",
      "charcoal": "charcoal",
      "spring_fade": "spring_fade",
      "autumn_fade": "autumn_fade",
      ...
      "magma_vein": "magma_vein",
      "ember_bed": "ember_bed",
      "glacier": "glacier",
      "frost_breath": "frost_breath",
      "moonlit_pool": "moonlit_pool",
      "star_parade": "star_parade",
      "galaxy_swirl": "galaxy_swirl",
      // New biome coverage slimes
      "canopy_lantern": "canopy_lantern",
      "moss_quilt": "moss_quilt",
      "acorn_buddy": "acorn_buddy",
      "pearl_whisper": "pearl_whisper",
      "kelp_curl": "kelp_curl",
      "tide_glass": "tide_glass",
      "snow_lantern": "snow_lantern",
      "frost_fern": "frost_fern",
      "drift_puff": "drift_puff",
      "redwall_glow": "redwall_glow",
      "desert_varnish": "desert_varnish",
      "swallow_sweep": "swallow_sweep",
      "aurora_veil_plus": "aurora_veil_plus",
      "polar_crown": "polar_crown",
      "ionosong": "ionosong",
      "acacia_shade": "acacia_shade",
      "grass_run": "grass_run",
      "sun_drum": "sun_drum",
      "coral_chorus": "coral_chorus",
      "anemone_wiggle": "anemone_wiggle",
      "shell_gleam": "shell_gleam",
      "glyph_bloom": "glyph_bloom",
      "vine_inlay": "vine_inlay",
      "incense_drift": "incense_drift",
      "lighthouse_wink": "lighthouse_wink",
      "rope_coil": "rope_coil",
      "foam_crest": "foam_crest",
      "anvil_ember": "anvil_ember",
      "forge_rune": "forge_rune",
      "quench_mist": "quench_mist",
      // Legacy production mappings
      "green_prod": "green",
      "mint_prod": "mint", 
