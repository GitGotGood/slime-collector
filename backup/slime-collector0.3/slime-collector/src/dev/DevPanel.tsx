...
import { Palette, Eye, Layout, Blend, Map } from "lucide-react";

export default function DevPanel({ onOpenSkinGallery, onOpenExperiments, onOpenLayoutPreview, onOpenEdgeBlending, onOpenWorldMap }: { onOpenSkinGallery?: () => void; onOpenExperiments?: () => void; onOpenLayoutPreview?: () => void; onOpenEdgeBlending?: () => void; onOpenWorldMap?: () => void }) {
