...
export default function QuestionCard({
  ...
  return (
    <div className="relative rounded-2xl bg-gradient-to-br from-emerald-100 to-lime-100 border border-emerald-200 p-6 sm:p-8">
      <div className="text-center">
        <div className="text-5xl sm:text-6xl font-black text-emerald-800 drop-shadow-sm select-none">
          {problem.a} <span className="text-emerald-600">{problem.symbol}</span> {problem.b}{" "}
